...
set "BACKGROUND=Find the mathematical function skeleton that represents magnetorheological effect in shear mode, given data on lambda12(L1/L2), and lambda23(L2/L3). L1, L2, and L3 are the long axis, medium axis, and short axis of the cuboid particle."
call :run_problem MRFShear-Cuboid "data/MRFShear-Cuboid/train.csv"

set "BACKGROUND=Find the mathematical function skeleton that represents magnetorheological effect in shear mode, given data on lambda12(L1/L2). L1 and L2 are the long axis and short axis of the ellipsoid particle."
...
set "BACKGROUND=Find the mathematical function skeleton that represents magnetorheological effect in compress mode, given data on lambda12(L1/L2), and lambda23(L2/L3). L1, L2, and L3 are the long axis, medium axis, and short axis of the cuboid particle."
call :run_problem MRFCompress-Cuboid "data/MRFCompress-Cuboid/train.csv"

set "BACKGROUND=Find the mathematical function skeleton that represents magnetorheological effect in compress mode, given data on lambda12(L1/L2). L1 and L2 are the long axis and short axis of the ellipsoid particle."
