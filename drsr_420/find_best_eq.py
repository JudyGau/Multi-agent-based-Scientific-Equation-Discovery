"""兼容层（@deprecated）：旧路径 ``drsr_420.find_best_eq`` → 新路径 ``drsr_420.analysis.find_best_eq``。
...
from drsr_420.analysis.find_best_eq import *            # noqa: F401,F403  触发子模块导入
from drsr_420.analysis import find_best_eq as _impl
