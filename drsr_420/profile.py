"""兼容层（@deprecated）：旧路径 ``drsr_420.profile`` → 新路径 ``drsr_420.core.profile``。
...
from drsr_420.core.profile import *            # noqa: F401,F403  触发子模块导入
from drsr_420.core import profile as _impl
