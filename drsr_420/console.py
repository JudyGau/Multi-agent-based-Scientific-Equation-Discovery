"""兼容层（@deprecated）：旧路径 ``drsr_420.console`` → 新路径 ``drsr_420.core.console``。
...
from drsr_420.core.console import *            # noqa: F401,F403  触发子模块导入
from drsr_420.core import console as _impl
