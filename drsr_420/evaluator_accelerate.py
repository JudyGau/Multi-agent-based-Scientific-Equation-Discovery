"""兼容层（@deprecated）：旧路径 ``drsr_420.evaluator_accelerate`` → 新路径 ``drsr_420.evaluation.accelerate``。
...
from drsr_420.evaluation.accelerate import *            # noqa: F401,F403  触发子模块导入
from drsr_420.evaluation import accelerate as _impl
