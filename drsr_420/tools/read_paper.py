"""兼容层（@deprecated）：旧路径 ``drsr_420.tools.read_paper`` → 新路径 ``drsr_420.knowledge.tools.read_paper``。
...
from drsr_420.knowledge.tools.read_paper import *            # noqa: F401,F403  触发子模块导入
from drsr_420.knowledge.tools import read_paper as _impl
