"""兼容层（@deprecated）：旧路径 ``drsr_420.tools.mcp_server`` → 新路径 ``drsr_420.knowledge.tools.mcp_server``。
...
from drsr_420.knowledge.tools.mcp_server import *            # noqa: F401,F403  触发子模块导入
from drsr_420.knowledge.tools import mcp_server as _impl
