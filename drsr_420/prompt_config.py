"""兼容层（@deprecated）：旧路径 ``drsr_420.prompt_config`` → 新路径 ``drsr_420.core.prompt_config``。
...
from drsr_420.core.prompt_config import *            # noqa: F401,F403  触发子模块导入
from drsr_420.core import prompt_config as _impl
