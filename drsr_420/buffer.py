"""兼容层（@deprecated）：旧路径 ``drsr_420.buffer`` → 新路径 ``drsr_420.core.buffer``。
...
from drsr_420.core.buffer import *            # noqa: F401,F403  触发子模块导入
from drsr_420.core import buffer as _impl
