"""兼容层（@deprecated）：旧路径 ``drsr_420.code_manipulation`` → 新路径 ``drsr_420.core.code_manipulation``。
...
from drsr_420.core.code_manipulation import *            # noqa: F401,F403  触发子模块导入
from drsr_420.core import code_manipulation as _impl
