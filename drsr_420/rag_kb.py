"""兼容层（@deprecated）：旧路径 ``drsr_420.rag_kb`` → 新路径 ``drsr_420.knowledge.rag_kb``。
...
from drsr_420.knowledge.rag_kb import *            # noqa: F401,F403  触发子模块导入
from drsr_420.knowledge import rag_kb as _impl
