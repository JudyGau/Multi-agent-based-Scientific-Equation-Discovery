"""兼容层（@deprecated）：旧路径 ``drsr_420.pipeline`` → 新路径 ``drsr_420.runtime.pipeline``。
...
from drsr_420.runtime.pipeline import *            # noqa: F401,F403  触发子模块导入
from drsr_420.runtime import pipeline as _impl
