"""兼容层（@deprecated）：旧路径 ``drsr_420.tool_runner`` → 新路径 ``drsr_420.knowledge.tool_runner``。
...
from drsr_420.knowledge.tool_runner import *            # noqa: F401,F403  触发子模块导入
from drsr_420.knowledge import tool_runner as _impl
