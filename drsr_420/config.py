"""兼容层（@deprecated）：旧路径 ``drsr_420.config`` → 新路径 ``drsr_420.core.config``。
...
from drsr_420.core.config import *            # noqa: F401,F403  触发子模块导入
from drsr_420.core import config as _impl
